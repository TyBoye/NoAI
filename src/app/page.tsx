          ...
          <div className="lg:grid lg:grid-cols-12 lg:gap-8">
            <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                Practice your negotiation skills with our AI-powered chatbot.
                Get real-time feedback and improve with every conversation.
              </p>
              <div className="flex justify-center gap-4">
                <SignedOut>
                  <SignInButton mode="modal">
                    <Button
                      className="bg-[#ff914d] text-white hover:cursor-pointer"
                      variant="outline"
                      size="lg"
                    >
          ...
          <div>
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <Card className="flex flex-col shadow-2xl px-8 py-12 transition-all duration-300 hover:shadow-orange-200 hover:scale-105">
                ...
                <CardHeader className="text-[#ff914d] flex justify-center font-bold text-lg">
                  Realistic Scenarios
                </CardHeader>
              ...
              <Card className="flex flex-col shadow-2xl px-8 py-12 transition-all duration-300 hover:shadow-orange-200 hover:scale-105">
                ...
                <CardDescription className="flex justify-center text-md">
                  Get real-time analysis of your negotiation tactics and
              ...
              <Card className="flex flex-col shadow-2xl px-8 py-12 transition-all duration-300 hover:shadow-orange-200 hover:scale-105">
                ...
                <CardDescription className="flex justify-center text-md">
                  Master proven negotiation strategies and apply them in your
                  practice lessons.
                </CardDescription>
              </Card>
            </div>
      ...
      <section className="py-16 bg-[#d8b48b]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-md md:text-lg text-white mb-8">
            Be among the few who take the first step and turn every negotiation
            into a win.
          </p>
          <div className="flex justify-center gap-4">
            <SignedOut>
