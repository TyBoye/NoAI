          ...
          <SidebarContent>
            <SidebarMenu>
                <SidebarMenuItem >
                    ...
                    <span className="text-md font-semibold ">New Negotiation</span>
